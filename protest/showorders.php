...
$sql="SELECT ordern , USERNAME,EMAIL,date
FROM orders B
 LEFT JOIN users_tb C ON C.USER_ID = B.USER_ID GROUP BY ordern, USERNAME,EMAIL,date ;";
...
<section>
    ...
    <div style="display: flex ; flex-direction: column ">
                <!-- 1--> <div style="box-shadow:  2px 2px 10px #000; background-color:#f6fdf6; width:  100%; height: 30%; padding-top:5px;text-align: center;font-size: 60px; margin-top:140px;border-bottom: 1px solid #d1e9c8">  <h1 style="margin-top: 70px">orders info</h1> </div>
        <!-- 2--> <div style="display: flex ; flex-direction: row ">
            <div class="right-side" style="width:  20%; border-top: #d1e9c8 solid 1px">
                ...
                <ul class="product-categories">
                    ...
                    <li>
                        <a href="userscomment.php" class="french">  users comments </a>
                    </li>
                    <li>
...
<td>     <a href="userorders.php?order_id=<?php echo $row['ordern']; ?>"><pre class="sign">veiw order</pre></a> </td>
