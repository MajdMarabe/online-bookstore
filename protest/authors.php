...
<head>
    <meta charset="UTF-8">
    <title>Authors info||Admin</title>
...
<section>
    ...
    <div style="display: flex ; flex-direction: column ">
        <!-- 1--> <div style="box-shadow:  2px 2px 10px #000; background-color:#f6fdf6; width:  100%; height: 30%; padding-top:5px;text-align: center;font-size: 60px; margin-top:140px;border-bottom: 1px solid #d1e9c8">  <h1 style="margin-top: 70px">Authors info</h1> </div>
        <!-- 2--> <div style="display: flex ; flex-direction: row ">
            ...
            <div class="Books" style="display: flex ; flex-direction: column ;width:  80%;font-size: 20px;   background-color: #f6fdf6 ; border-top: #d1e9c8 solid 1px">
                ...
                <form class="a" method="get" action="addauthor.php">
            ...
            <center><div>
                    <table style="border: black 1px solid">
                        ...
                        while($row=mysqli_fetch_assoc($all_product)){?>
                            ...
                            <td>  <?php
                                $semail="SELECT COUNT(*) CNTM FROM book WHERE author_id = '$row[author_id]'";



                                if($esult=$mysqli->query($semail)) {
                                    $r = mysqli_fetch_assoc($esult);
                                    echo  $r['CNTM'] ;
                            ...
                            <td>  <a href="deleteauthor.php?isbn=<?php echo $row['author_id'];
