...
<section>
    ...
    <div style="display: flex ; flex-direction: column ">
        <!-- 1--> <div style="box-shadow:  2px 2px 10px #000; background-color:#f6fdf6; width:  100%; height: 30%; padding-top:5px;text-align: center;font-size: 60px; margin-top:140px;border-bottom: 1px solid #d1e9c8">  <h1 style="margin-top: 70px">New Arrivals & Global Trends</h1> </div>
                        ...
                        <table style="">
                            ...
                            while($row=mysqli_fetch_assoc($all_product)){?>
                                ...
                                <tr>
                                    ...
                                    <td>  <a href="deletetrend.php?isbn=<?php echo $row['isbn']; ?>" >
